...
export class TaskManagerService {
  ...
  getDashboard(): Observable<DashboardData> {
    return this.http.get<DashboardData>(environment.apiUrl + 'flower/dashboard?json=1');
  }
  ...
  getTasks(start: number, limit: number, order?: string, searchValue?: string): Observable<TasksData> {
    ...
    return this.http.get<TasksData>(environment.apiUrl + 'flower/' + tasksUglyUrl);
  }
  ...
  getTask(uuid: string): Observable<Task> {
    return this.http.get<Task>(environment.apiUrl + 'flower/api/task/info/' + uuid);
  }
  ...
  getWorkers(): Observable<any> {
    return this.http.get<any>(environment.apiUrl + 'flower/api/workers?refresh=1');
  }
  ...
  getWorker(workerName: string): Observable<Worker> {
    return this.http.get<any>(environment.apiUrl + 'flower/api/workers?refresh=1').pipe(
  ...
  poolSizeGrow(workerName: string, shrinkSize: number) {
    ...
    return this.http.post(environment.apiUrl + 'flower/api/worker/pool/grow/' + workerName, data, httpOptions);
  }
  ...
  poolSizeShrink(workerName: string, shrinkSize: number) {
    ...
    return this.http.post(environment.apiUrl + 'flower/api/worker/pool/shrink/' + workerName, data, httpOptions);
  }
  ...
  poolAutoscale(workerName: string, min: number, max: number) {
    ...
    return this.http.post(environment.apiUrl + 'flower/api/worker/pool/autoscale/' + workerName, data, httpOptions);
  }
  ...
  cancelConsumer(workerName: string, queue: string) {
    ...
    return this.http.post(
      environment.apiUrl + 'flower/api/worker/queue/cancel-consumer/' + workerName,
      data,
      httpOptions
    );
  }
  ...
  editTaskTimeout(workerName: string, taskName: string, timeout: number) {
    ...
    return this.http.post(environment.apiUrl + 'flower/api/task/timeout/' + taskName, data, httpOptions);
  }
  ...
  editTaskRateLimit(workerName: string, taskName: string, ratelimit: number) {
    ...
    return this.http.post(environment.apiUrl + 'flower/api/task/rate-limit/' + taskName, data, httpOptions);
  }
}
