...
@Component({
  selector: 'app-mission-graph',
  templateUrl: './orient-mission-graph.component.html',
  styleUrls: ['./orient-mission-graph.component.scss'],
})
export class OrientMissionGraphComponent implements OnInit, OnChanges {
  edges: Edge[];
  nodes: Node[];
  title: string;
  description: string;
